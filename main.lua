...
local ATTACK_ANIM_DUR = 12

local ATTACK_ANIM_BASE_DIAMETER = 138

local ATTACK_ANIM_OFFSET_Y = -10

local WAVE_RADIUS = 120
...
if EID then
    ...
    local trinketDesc = {
        ["cz_cz"] = "↑ +0.15 Rychlost#Malý bonus k atributům#Speciální interakce s Dash!/Celeste: Zvyšuje damage dashu z 2× → 2.5×",
        ...
        ["es"]    = "↑ +0.15 Velocidad#Pequeño aumento de stats#Sinergia especial con Dash!/Celeste: daño del dash 2× → 2.5×",
        ["fr"]    = "↑ +0.15 Vitesse#Petit bonus de stats#Synergie spéciale avec Dash!/Celeste : dégâts du dash 2× → 2.5×",
        ["it"]    = "↑ +0.15 Velocità#Leggero bonus alle statistiche#Sinergia con Dash!/Celeste: danno dello scatto 2× → 2.5×",
    ...
    local passiveDesc = {
        ["cz_cz"] = "Poškození ×2.5, ↓ -1 Slzy, ↑ +0.25 Rychlost, Slzy se dělí.#Každé 4s vyvolá rázovou vlnu, která způsobí 2.5× vašeho poškození nepřátelům v okolí.#Občas obnoví půl srdce#Pokud máte Dash!, použití Dash! okamžitě aktivuje vlnu a resetuje její cooldown.",
        ["de"]    = "Schaden ×2.5, ↓ -1 Tränen, ↑ +0.25 Geschwindigkeit, Tränen teilen sich.#Alle 4s erzeugt es eine Schockwelle, die Gegnern in der Nähe 2.5× deines Schadens zufügt.#Heilt gelegentlich ein halbes Herz#Wenn du Dash! hast, löst die Benutzung von Dash! die Welle sofort aus und setzt deren Abklingzeit zurück.",
        ["en_us"] = "Damage ×2.5, ↓ -1 Tears, ↑ +0.25 Speed, Tears split.#Every 4s emits a shockwave that deals 2.5× your damage to nearby enemies.#Occasionally regenerates half a heart#If you have Dash!, using Dash! immediately triggers the wave and resets its cooldown.",
        ["es"]    = "Daño ×2.5, ↓ -1 Lagrimas, ↑ +0.25 Velocidad, Las lágrimas se dividen.#Cada 4s emite una onda expansiva que inflige 2.5× tu daño a enemigos cercanos.#Regenera de vez en cuando medio corazon#Si tienes Dash!, usar Dash! activa la onda inmediatamente y reinicia su cooldown.",
        ["fr"]    = "Dégâts ×2.5, ↓ -1 Larmes, ↑ +0.25 Vitesse, Les larmes se divisent.#Toutes les 4s émet une onde de choc qui inflige 2.5× vos dégâts aux ennemis proches.#Régénère de temps en temps un demi-cœur#Si vous avez Dash!, l'utilisation de Dash! déclenche immédiatement l'onde et réinitialise son cooldown.",
        ["it"]    = "Danno ×2.5, ↓ -1 Lacrime, ↑ +0.25 Velocità, Le lacrime si dividono.#Ogni 4s emette un'onda d'urto che infligge 2.5× il tuo danno ai nemici vicini.#Rigenera di tanto in tanto mezzo cuore#Se hai Dash!, usare Dash! attiva immediatamente l'onda e resetta il suo cooldown.",
        ["ja_jp"] = "ダメージ ×2.5、↓ -1 涙、↑ +0.25 移動速度、涙が分裂する。#4秒ごとに周囲に衝撃波を放ち、近くの敵にあなたのダメージの2.5倍を与える。#ランダムでハーフハートを回復することがある。#Dash!を所持している場合、Dash!を使うと衝撃波が即座に発動し、クールダウンをリセットする。",
        ["ko_kr"] = "데미지 ×2.5, ↓ -1 눈물, ↑ +0.25 이동속도, 눈물이 분열한다.#4초마다 주변에 충격파를 방출하여 근처 적에게 당신의 데미지의 2.5배를 입힌다.#가끔 반 하트를 회복한다#Dash!를 가지고 있다면 Dash! 사용 시 즉시 파동이 발동하고 재사용 대기시간이 초기화된다.",
        ["ro_ro"] = "Daune ×2.5, ↓ -1 Lacrimi, ↑ +0.25 Viteză, Lacrimile se împart.#La fiecare 4s emite o undă de șoc care aplică 2.5× daunele tale inamicilor apropiați.#Uneori regenerează jumătate de inimă#Dacă ai Dash!, folosirea Dash! activează imediat unda și resetează cooldown-ul.",
        ["ru"]    = "Урон ×2.5, ↓ -1 Слеза, ↑ +0.25 Скорость, Слезы делятся.#Каждые 4 с испускает ударную волну, наносящую 2.5× вашего урона ближайшим врагам.#Иногда восстанавливает половину сердца#Если у вас есть Dash!, использование Dash! мгновенно активирует волну и сбросит её перезарядку.",
        ["uk_ua"] = "Шкода ×2.5, ↓ -1 Сльоза, ↑ +0.25 Швидкість, Сльози діляться.#Кожні 4 с випромінює ударну хвилю, яка завдає 2.5× вашого ушкодження ближнім ворогам.#Іноді відновлює половину серця#Якщо у вас є Dash!, використання Dash! миттєво активує хвилю і скине її кулдаун.",
        ["vi"]    = "Sát thương ×2.5, ↓ -1 Lệ, ↑ +0.25 Tốc độ, Đạn tách.#Mỗi 4s phát ra một làn sóng gây 2.5× sát thương của bạn lên kẻ địch gần đó.#Thỉnh thoảng hồi nửa trái tim#Nếu bạn có Dash!, dùng Dash! sẽ kích hoạt làn sóng ngay lập tức và đặt lại thời gian hồi.",
        ["zh_cn"] = "伤害 ×2.5，↓ -1 眼泪，↑ +0.25 速度，眼泪分裂。#每4秒发出一次冲击波，对附近敌人造成你伤害的2.5倍。#有时会恢复半颗心#如果你拥有 Dash!，使用 Dash! 会立即触发冲击波并重置冷却。"
    }
...
local function SpriteScaleForRadius(player, radius)
    local baseDiam = ATTACK_ANIM_BASE_DIAMETER or 64
    ...
    local spriteScale = desiredPixelDiam / baseDiam
...
function mod:OnEvaluateCache(player, cacheFlag)
    local d=player:GetData() d._TearBonus=d._TearBonus or 0
...
mod:AddCallback(ModCallbacks.MC_POST_PEFFECT_UPDATE, function(_,p) if p:HasTrinket(TRINKET_ID) then p:EvaluateItems() end end)
...
function ChargeBarRender(Meter,IsCharging,pos,Sprite)
    ...
    if IsCharging then
        if pct<99 then Sprite:SetFrame("Charging",math.floor(pct))
        else if not Sprite:IsPlaying("Charged") then Sprite:Play("Charged",true) end end
    elseif not Sprite:IsPlaying("Disappear") and not Sprite:IsFinished("Disappear") then
        Sprite:Play("Disappear",true) end
...
function mod:cache(player,cacheFlag)
    ...
    if cacheFlag==CacheFlag.CACHE_DAMAGE then player.Damage=player.Damage-1
    elseif cacheFlag==CacheFlag.CACHE_FIREDELAY then player.MaxFireDelay=CalculateTears(player.MaxFireDelay,0.5)
    elseif cacheFlag==CacheFlag.CACHE_SPEED then player.MoveSpeed=player.MoveSpeed+0.15 end
end
